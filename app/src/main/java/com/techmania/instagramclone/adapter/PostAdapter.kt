...
import com.techmania.instagramclone.databinding.PostRvBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        try{
            Firebase.firestore.collection(USER_NODE).document(postList.get(position).uid).get().addOnSuccessListener {
                ...
                Glide.with(context).load(user!!.image).placeholder(R.drawable.user).into(holder.binding.postImage)
